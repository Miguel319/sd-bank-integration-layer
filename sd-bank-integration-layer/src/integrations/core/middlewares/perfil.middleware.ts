...
// @access Private
const createPerfil = asyncHandler(
...
// @access Private
const getPerfiles = asyncHandler(
...
// @route  GET /api/v1/perfiles
// @access Private
const getPerfilPorId = asyncHandler(
  async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    const estado = Estado.getInstance();
...
// @access Private
const updatePerfil = asyncHandler(
  async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    const estado = Estado.getInstance();
    ...
    if (estado.getArriba()) {
      ...
      try {
        ...
        const perfilEncontrado: any = await Perfil.findById(_id).session(
          session
        );
...
// @access Private
const deletePerfil = asyncHandler(
  async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    const estado = Estado.getInstance();
...
export default perfilMiddleware;
