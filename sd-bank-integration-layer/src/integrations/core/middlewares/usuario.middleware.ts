...
const getAllUsuarios = asyncHandler(
  async (
    req: Request,
    res: Response,
    next: NextFunction
...
const getUsuarioById = asyncHandler(
  async (
    req: Request,
    res: Response,
    next: NextFunction
...
// @access   Public
const createUsuario = asyncHandler(
  async (
    req: Request,
    res: Response,
    next: NextFunction
...
const getEntidadesAsociadasByPerfil = asyncHandler(
  async (
    req: Request,
    res: Response,
    next: NextFunction
...
const getEntidadByUsuarioId = asyncHandler(
  async (
    req: Request,
    res: Response,
    next: NextFunction
...
const updateUsuario = asyncHandler(
  async (
    req: Request,
    res: Response,
    next: NextFunction
...
const deleteUsuario = asyncHandler(
  async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    const estado = Estado.getInstance();
